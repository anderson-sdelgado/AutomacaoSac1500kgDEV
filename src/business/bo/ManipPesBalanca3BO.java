 ...
 * @author anderson
 */
public class ManipPesBalanca3BO extends Thread {
    ...
    public ManipPesBalanca3BO(TelaPrincipal principal) {
    ...
    public void run(){
        ...
        if(pesagem.substring(2, 3).equals("1")){
            pesEsteira.setNumBalanca("6");
        }
        else{
            pesEsteira.setNumBalanca("7");
        }
